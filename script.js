...
buttonElement.addEventListener('click', function(){
    ...
    */
    if (inputElement.value.toLowerCase().includes("non sei") || inputElement.value.toLowerCase().includes("non 6") || inputElement.value.toLowerCase().includes("non ha bevuto sei") || inputElement.value.toLowerCase().includes("non ha bevuto 6") || inputElement.value.toLowerCase().includes("16") || inputElement.value.toLowerCase().includes("26") || inputElement.value.toLowerCase().includes("36") || inputElement.value.toLowerCase().includes("46") || inputElement.value.toLowerCase().includes("56") || inputElement.value.toLowerCase().includes("66") || inputElement.value.toLowerCase().includes("76") || inputElement.value.toLowerCase().includes("86") || inputElement.value.toLowerCase().includes("96")) {
        inputElement.value= '';
